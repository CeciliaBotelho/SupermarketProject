...
(300, 'Bolacha', 9.99, 24);
desc tbprodutos;
select * from tbprodutos; -- o asterisco e para dar select em todas as colunas
select idProd as codProduto, codbarra as codBarras, nomeprod as nomeProduto, precoprod as preco, quantprod as estoque; -- renomei para ficar bonito
...
desc tbvendas; -- consegue ver a descrição da tabela
select * from tbvendas;-- para conseguir ver a tabela(o que tem nela)
...
-- ponto e para indicar o campo
-- identifica as colunas que tu quer q aparecam e junta com tbvendas, filtrara as colunas
on tbvendas.idcli = tbclientes.idcli  -- junta tudo que tiver o mesmo id cli da tabela vendas e clientes
